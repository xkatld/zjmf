...
class SystemController extends AdminBaseController
{
	...
	{
		// 开源版本固定版本为1.0.0，无需获取远程更新内容
		$str = "<h1>当前版本 1.0.0</h1><p>开源版本，无需更新。</p>";
...
";
	...
	{
		// 开源版本不支持在线升级，版本已是最新
		return jsonrule(["status" => 200, "msg" => "当前已是最新版本 1.0.0，无需升级"]);
	}
	/**
	 * @title 检测系统更新进度
	...
	{
		// 开源版本不支持在线升级
		return json(["status" => 200, "msg" => "当前已是最新版本 1.0.0，无需升级", "progress" => "100%"]);
	}
